...
# Target: 1.5 GHz (667 ps period) - Maximum Performance
# Date: Dec 2025
...
set_clock_uncertainty 15 [get_clocks $clk_name]

# Input/output delays - 10% of period for tight timing
...
# Max transition for high-speed design
