#!/bin/bash
# ============================================================
# Tritone TPU SoC - Docker OpenROAD Flow (ASAP7)
# ============================================================
# Usage: ./run_tritone_soc_docker.sh [baseline|aggressive|maxperf]
#
# Variants:
#   baseline   - 1.0 GHz target (default, recommended)
#   aggressive - 1.5 GHz target
#   maxperf    - 2.0 GHz target (requires pipelined MAC)
#
# Date: Jan 2026
# ============================================================
...
# Check results
RESULT_DIR="flow/results/asap7/tritone_soc"
